...
# kernel path: /tmp/torchinductor_goon/pr/cprbe3xggfjkp5pc76lzigiq2oh6yfwofmhnnplhsbuqoadvr4u2.py
...
def call(args):
    ...
    assert_size_stride(le, (1, 256), (256, 1))
    assert_size_stride(tangents_1, (1, 256), (256, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((1, 256), (256, 1), torch.float32)
        # Source Nodes: [], Original ATen: [aten.threshold_backward]
        stream0 = get_raw_stream(0)
        triton_poi_fused_threshold_backward_0.run(le, tangents_1, buf0, 256, grid=grid(256), stream=stream0)
        del le
        del tangents_1
        buf1 = empty_strided_cuda((256, 128), (128, 1), torch.float32)
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf0, (256, 1), (1, 0), 0), primals_2, out=buf1)
        del buf0
        del primals_2
    return (reinterpret_tensor(buf1, (256, 128), (128, 1), 0), None, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    le = rand_strided((1, 256), (256, 1), device='cuda:0', dtype=torch.bool)
    tangents_1 = rand_strided((1, 256), (256, 1), device='cuda:0', dtype=torch.float32)
