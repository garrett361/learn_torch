class GraphModule(torch.nn.Module):
    def forward(self, primals_2: "f32[1, 128]", le: "b8[1, 128]", permute_3: "f32[128, 128]", tangents_1: "f32[1, 128]"):
        ...
        permute_1: "f32[128, 1]" = torch.ops.aten.permute.default(where, [1, 0])
        ...
        mm_2: "f32[1, 128]" = torch.ops.aten.mm.default(where, permute_3);  where = permute_3 = None
        permute_4: "f32[128, 128]" = torch.ops.aten.permute.default(permute_2, [1, 0]);  permute_2 = None
