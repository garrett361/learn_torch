class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "bf16[1, 16]", primals_2: "bf16[128]", primals_3: "bf16[16, 16]", primals_4, primals_5: "bf16[128]", primals_6: "bf16[16, 16]", primals_7: "bf16[128]", primals_8: "bf16[16, 16]"):
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.6.0/lib/python3.12/site-packages/torch/distributed/fsdp/_fully_shard/_fsdp_collectives.py:153 in foreach_all_gather, code: all_gather_input, all_gather_output = torch.ops.fsdp.all_gather_copy_in(
        ...
        getitem: "bf16[128]" = all_gather_copy_in[0];  all_gather_copy_in = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.6.0/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:205 in all_gather_tensor, code: tensor = torch.ops._c10d_functional.all_gather_into_tensor(
        ...
        getitem_3: "bf16[256]" = auto_functionalized_v2[1];  auto_functionalized_v2 = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.6.0/lib/python3.12/site-packages/torch/distributed/fsdp/_fully_shard/_fsdp_param.py:522 in init_unsharded_param, code: self._unsharded_param.untyped_storage().resize_(
        ...
        relu: "bf16[1, 16]" = torch.ops.aten.relu.default(mm);  mm = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.6.0/lib/python3.12/site-packages/torch/distributed/fsdp/_fully_shard/_fsdp_param.py:667 in free_unsharded_param, code: self._unsharded_param.untyped_storage().resize_(0)
