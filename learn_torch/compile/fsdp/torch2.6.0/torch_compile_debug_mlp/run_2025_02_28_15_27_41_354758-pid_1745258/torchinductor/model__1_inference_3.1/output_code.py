...
# kernel path: /tmp/torchinductor_goon/hi/chiak4qv6kb3o466eaciy3yx2f5yk6iz422shefman6w3b6p2gm5.py
...
# kernel path: /tmp/torchinductor_goon/gh/cghdqijuu3aplf6jn73ddsdqok5h7gjnzqlaiggo6txj73r4afw4.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %full_default : [num_users=3] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:1, pin_memory: False})
...
# kernel path: /tmp/torchinductor_goon/bw/cbwvxndbt3uwmivve44xpxrxnaax7kl43eiviunlfmm64lltwyqw.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(1):
        ...
        triton_poi_fused_0.run(arg6_1, arg0_1, buf11, 16, grid=grid(16), stream=stream1)
        del arg0_1
        del arg6_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream1 = get_raw_stream(1)
        triton_poi_fused_1.run(buf25, arg5_1, 16, grid=grid(16), stream=stream1)
        del arg5_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream1 = get_raw_stream(1)
        triton_poi_fused_1.run(buf39, arg4_1, 16, grid=grid(16), stream=stream1)
        del arg4_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream1 = get_raw_stream(1)
        triton_poi_fused_2.run(arg11_1, buf45, arg11_1, 128, grid=grid(128), stream=stream1)
        del buf45
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream1 = get_raw_stream(1)
        triton_poi_fused_2.run(arg12_1, buf52, arg12_1, 128, grid=grid(128), stream=stream1)
        del buf52
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        stream1 = get_raw_stream(1)
        triton_poi_fused_2.run(arg13_1, buf59, arg13_1, 128, grid=grid(128), stream=stream1)
        del buf59
