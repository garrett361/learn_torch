...
# kernel path: /tmp/torchinductor_goon/63/c635cgswdfq2t7m7ccnapse3c7vywzlxqedcrvyzz3imrmxppw5o.py
...
# kernel path: /tmp/torchinductor_goon/y7/cy7fejpniuv5562nwkc7cwwo4k2or2557r2vtq34qinxguqwdcyh.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(1):
        ...
        buf0 = torch.ops.fsdp.all_gather_copy_in.default([primals_2], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del primals_2
        buf1 = buf0[0]
        buf2 = buf0[1]
        del buf0
        ...
        # Topologically Sorted Source Nodes: [split_with_sizes_copy], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf12, 16, grid=grid(16), stream=stream1)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf13 = torch.ops.fsdp.all_gather_copy_in.default([primals_5], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del primals_5
        buf14 = buf13[0]
        buf15 = buf13[1]
        del buf13
        ...
        # Topologically Sorted Source Nodes: [split_with_sizes_copy_1], Original ATen: []
        ...
        stream1 = get_raw_stream(1)
        triton_poi_fused_relu_0.run(buf25, 16, grid=grid(16), stream=stream1)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf26 = torch.ops.fsdp.all_gather_copy_in.default([primals_7], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del primals_7
        buf27 = buf26[0]
        buf28 = buf26[1]
        del buf26
        ...
        # Topologically Sorted Source Nodes: [split_with_sizes_copy_2], Original ATen: []
        ...
        # Topologically Sorted Source Nodes: [outputs_2], Original ATen: [aten.relu, aten.threshold_backward]
        stream1 = get_raw_stream(1)
        triton_poi_fused_relu_threshold_backward_1.run(buf38, buf39, 16, grid=grid(16), stream=stream1)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_1 = rand_strided((1, 16), (16, 1), device='cuda:1', dtype=torch.bfloat16)
    primals_2 = rand_strided((128, ), (1, ), device='cuda:1', dtype=torch.bfloat16)
    primals_3 = rand_strided((16, 16), (16, 1), device='cuda:1', dtype=torch.bfloat16)
    primals_5 = rand_strided((128, ), (1, ), device='cuda:1', dtype=torch.bfloat16)
    primals_6 = rand_strided((16, 16), (16, 1), device='cuda:1', dtype=torch.bfloat16)
    primals_7 = rand_strided((128, ), (1, ), device='cuda:1', dtype=torch.bfloat16)
    primals_8 = rand_strided((16, 16), (16, 1), device='cuda:1', dtype=torch.bfloat16)
