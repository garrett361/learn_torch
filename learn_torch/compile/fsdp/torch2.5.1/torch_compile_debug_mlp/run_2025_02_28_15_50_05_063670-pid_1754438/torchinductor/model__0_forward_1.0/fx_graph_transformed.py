class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "bf16[1, 16]", primals_2: "bf16[128]", primals_3: "bf16[16, 16]", primals_4, primals_5: "bf16[128]", primals_6: "bf16[16, 16]", primals_7: "bf16[128]", primals_8: "bf16[16, 16]"):
        ...
        all_gather_copy_in_default_2 = torch.ops.fsdp.all_gather_copy_in.default([primals_2], [128], 128, 2, 0, torch.bfloat16, device(type='cuda', index=0));  primals_2 = None
        ...
        # No stacktrace found for following nodes
        all_gather_copy_in_default_1 = torch.ops.fsdp.all_gather_copy_in.default([primals_5], [128], 128, 2, 0, torch.bfloat16, device(type='cuda', index=0));  primals_5 = None
        ...
        # No stacktrace found for following nodes
        all_gather_copy_in_default = torch.ops.fsdp.all_gather_copy_in.default([primals_7], [128], 128, 2, 0, torch.bfloat16, device(type='cuda', index=0));  primals_7 = None
