...
# kernel path: /tmp/torchinductor_goon/66/c66e3oef6ssewpk6pxaks4ioef37bnnb5fzlgwtvr6a6poshep4p.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /tmp/torchinductor_goon/cr/ccrl47ejenvsmmh4bjdqdkawxayurlyl3xb6z3ox7ve7tga5guh7.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %le : [num_users=1] = call_function[target=torch.ops.aten.le.Scalar](args = (%arg5_1, 0), kwargs = {})
#   %full_default_1 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:0, pin_memory: False})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf1 = torch.ops.fsdp.all_gather_copy_in.default([arg8_1], [128], 128, 2, 0, torch.bfloat16, device(type='cuda', index=0))
        del arg8_1
        buf2 = buf1[0]
        buf3 = buf1[1]
        del buf1
        ...
        triton_poi_fused_0.run(buf0, buf9, 256, grid=grid(256), stream=stream0)
        buf15 = empty_strided_cuda((1, 16), (16, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(arg6_1, arg0_1, buf15, 16, grid=grid(16), stream=stream0)
        del arg0_1
        del arg6_1
        buf18 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
        buf27 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_0.run(buf18, buf27, 256, grid=grid(256), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf19 = torch.ops.fsdp.all_gather_copy_in.default([arg9_1], [128], 128, 2, 0, torch.bfloat16, device(type='cuda', index=0))
        del arg9_1
        buf20 = buf19[0]
        buf21 = buf19[1]
        del buf19
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_2.run(buf33, arg5_1, 16, grid=grid(16), stream=stream0)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf37 = torch.ops.fsdp.all_gather_copy_in.default([arg10_1], [128], 128, 2, 0, torch.bfloat16, device(type='cuda', index=0))
        del arg10_1
        buf38 = buf37[0]
        buf39 = buf37[1]
        del buf37
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_2.run(buf51, arg4_1, 16, grid=grid(16), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_0.run(buf36, buf45, 256, grid=grid(256), stream=stream0)
