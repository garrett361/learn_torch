class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "bf16[1, 16]", primals_2: "bf16[128]", primals_3: "bf16[16, 16]", primals_4, primals_5: "bf16[128]", primals_6: "bf16[16, 16]", primals_7: "bf16[128]", primals_8: "bf16[16, 16]"):
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_composable/fsdp/_fsdp_collectives.py:151 in foreach_all_gather, code: all_gather_input, all_gather_output = torch.ops.fsdp.all_gather_copy_in(
        ...
        getitem: "bf16[128]" = all_gather_copy_in[0];  all_gather_copy_in = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:204 in all_gather_tensor, code: tensor = torch.ops._c10d_functional.all_gather_into_tensor(
        ...
        wait_tensor: "bf16[256]" = torch.ops._c10d_functional.wait_tensor.default(all_gather_into_tensor);  all_gather_into_tensor = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_composable/fsdp/_fsdp_param.py:409 in init_all_gather_outputs, code: torch.empty(torch.Size([numel * world_size]), dtype=dtype, device=device)
        empty: "bf16[256]" = torch.ops.aten.empty.memory_format([256], dtype = torch.bfloat16, device = device(type='cuda', index=0), pin_memory = False)
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_composable/fsdp/_fsdp_collectives.py:274 in foreach_all_gather_copy_out, code: out = [t.view(world_size, -1) for t in gen]
        view_1: "bf16[2, 128]" = torch.ops.aten.view.default(empty, [2, -1])
        
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_composable/fsdp/_fsdp_collectives.py:275 in foreach_all_gather_copy_out, code: torch.ops.fsdp.split_with_sizes_copy(
        ...
        view_3: "bf16[256]" = torch.ops.aten.view.default(getitem_4, [256]);  getitem_4 = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_composable/fsdp/_fsdp_param.py:478 in init_unsharded_param, code: torch.ops.fsdp.set_.default(self._unsharded_param, unsharded_param)
