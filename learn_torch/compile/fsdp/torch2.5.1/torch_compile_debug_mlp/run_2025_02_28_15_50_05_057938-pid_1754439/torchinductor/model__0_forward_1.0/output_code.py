...
# kernel path: /tmp/torchinductor_goon/us/cusqqbuhsvvcqrn34ni5wy2c3lnqlqlskj4fbs5ory2r4jih6udq.py
...
# kernel path: /tmp/torchinductor_goon/qg/cqgkcrxfkacncy3kxgnpjennzlsq3g7w37yv7padewijzx2udq6i.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(1):
        ...
        triton_poi_fused_0.run(buf8, buf9, 256, grid=grid(256), stream=stream1)
        buf26 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
        buf27 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_0.run(buf26, buf27, 256, grid=grid(256), stream=stream1)
        buf44 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
        buf45 = empty_strided_cuda((256, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_0.run(buf44, buf45, 256, grid=grid(256), stream=stream1)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf18 = torch.ops.fsdp.all_gather_copy_in.default([primals_5], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del primals_5
        buf19 = buf18[0]
        buf20 = buf18[1]
        del buf18
        ...
        # Topologically Sorted Source Nodes: [output], Original ATen: [aten.relu]
        triton_poi_fused_relu_1.run(buf16, 16, grid=grid(16), stream=stream1)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf36 = torch.ops.fsdp.all_gather_copy_in.default([primals_7], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del primals_7
        buf37 = buf36[0]
        buf38 = buf36[1]
        del buf36
        ...
        triton_poi_fused_relu_1.run(buf34, 16, grid=grid(16), stream=stream1)
        ...
        # Topologically Sorted Source Nodes: [output_2], Original ATen: [aten.relu, aten.threshold_backward]
        triton_poi_fused_relu_threshold_backward_2.run(buf52, buf54, 16, grid=grid(16), stream=stream1)
