...
# kernel path: /tmp/torchinductor_goon/p4/cp4aaopkdi5gs24intbzsjivcbjxy6s4mfv72tr6fhxrc5ocacf3.py
# Topologically Sorted Source Nodes: [full], Original ATen: [aten.clone, aten.full, aten.where]
# Source node to ATen node mapping:
#   full => full_default
# Graph fragment:
#   %clone : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand,), kwargs = {memory_format: torch.contiguous_format})
#   %full_default : [num_users=3] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:1, pin_memory: False})
...
# kernel path: /tmp/torchinductor_goon/cn/ccnpftiuj76hemfozvwxhljlkgjbos2obpgw2pxxt3i7qtvvbe67.py
...
# kernel path: /tmp/torchinductor_goon/wh/cwhurf775mkp6ofzlikzx2zo4swiursh23rb7dfpjsjcmuh6sg2c.py
...
@triton_heuristics.pointwise(
    size_hints={'x': 128}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'out_ptr1': '*bf16', 'xnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=1, multi_processor_count=108, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})]},
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(1):
        ...
        buf0 = torch.ops.fsdp.all_gather_copy_in.default([arg8_1], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del arg8_1
        buf1 = buf0[0]
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: [fsdp.all_gather_copy_in]
        buf14 = torch.ops.fsdp.all_gather_copy_in.default([arg9_1], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del arg9_1
        buf15 = buf14[0]
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: [fsdp.all_gather_copy_in]
        buf28 = torch.ops.fsdp.all_gather_copy_in.default([arg10_1], [128], 128, 2, 1, torch.bfloat16, device(type='cuda', index=1))
        del arg10_1
        buf29 = buf28[0]
        ...
        triton_poi_fused_clone_full_where_0.run(arg6_1, arg0_1, buf11, 16, grid=grid(16), stream=stream1)
        del arg0_1
        del arg6_1
        ...
        # Topologically Sorted Source Nodes: [full], Original ATen: [aten.full, aten.le, aten.where]
        stream1 = get_raw_stream(1)
        triton_poi_fused_full_le_where_1.run(buf25, arg5_1, 16, grid=grid(16), stream=stream1)
        ...
        # Topologically Sorted Source Nodes: [full], Original ATen: [aten.full, aten.le, aten.where]
        stream1 = get_raw_stream(1)
        triton_poi_fused_full_le_where_1.run(buf39, arg4_1, 16, grid=grid(16), stream=stream1)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.copy_]
        stream1 = get_raw_stream(1)
        triton_poi_fused_add_copy__2.run(arg11_1, buf45, arg11_1, 128, grid=grid(128), stream=stream1)
        del buf45
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.copy_]
        stream1 = get_raw_stream(1)
        triton_poi_fused_add_copy__2.run(arg12_1, buf52, arg12_1, 128, grid=grid(128), stream=stream1)
        del buf52
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, aten.copy_]
        stream1 = get_raw_stream(1)
        triton_poi_fused_add_copy__2.run(arg13_1, buf59, arg13_1, 128, grid=grid(128), stream=stream1)
        del buf59
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg11_1 = rand_strided((8, 16), (16, 1), device='cuda:1', dtype=torch.bfloat16)
    arg12_1 = rand_strided((8, 16), (16, 1), device='cuda:1', dtype=torch.bfloat16)
    arg13_1 = rand_strided((8, 16), (16, 1), device='cuda:1', dtype=torch.bfloat16)
