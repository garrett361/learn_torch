...
os.environ['TORCHELASTIC_ERROR_FILE'] = '/tmp/torchelastic_vifde05a/none_8hzfntmr/attempt_0/1/error.json'
os.environ['TORCHINDUCTOR_CACHE_DIR'] = '/tmp/torchinductor_goon'
os.environ['TRITON_CACHE_DIR'] = '/tmp/torchinductor_goon/triton/1'
