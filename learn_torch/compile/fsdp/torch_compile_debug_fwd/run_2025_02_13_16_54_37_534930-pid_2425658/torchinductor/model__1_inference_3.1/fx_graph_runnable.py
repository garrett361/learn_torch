...
os.environ['TORCHELASTIC_ERROR_FILE'] = '/tmp/torchelastic_vifde05a/none_8hzfntmr/attempt_0/0/error.json'
os.environ['TORCHINDUCTOR_CACHE_DIR'] = '/tmp/torchinductor_goon'
os.environ['TRITON_CACHE_DIR'] = '/tmp/torchinductor_goon/triton/0'
...
# torch version: 2.7.0.dev20250213+cu124
# torch cuda version: 12.4
# torch git version: c709115e6c3f3f0eb25a37331721435835712302
...
def load_args(reader):
    ...
    buf2 = reader.storage(None, 0, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
    reader.tensor(buf2, (16, 16), dtype=torch.bfloat16, is_leaf=True)  # arg2_1
    buf3 = reader.storage(None, 0, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
    ...
    buf7 = reader.storage(None, 0, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
    ...
    buf11 = reader.storage(None, 256, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
    reader.tensor(buf11, (8, 16), dtype=torch.bfloat16, is_leaf=True)  # arg11_1
    buf12 = reader.storage(None, 256, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
    reader.tensor(buf12, (8, 16), dtype=torch.bfloat16, is_leaf=True)  # arg12_1
    buf13 = reader.storage(None, 256, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
