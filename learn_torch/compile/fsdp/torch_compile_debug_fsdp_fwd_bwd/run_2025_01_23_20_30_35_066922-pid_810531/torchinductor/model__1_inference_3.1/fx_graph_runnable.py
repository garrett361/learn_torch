...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1):
        ...
        full_default_1 = torch.ops.aten.full.default([], 0.0, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=1), pin_memory = False)
        ...
        full_default_2 = torch.ops.aten.full.default([], 0.0, dtype = torch.bfloat16, layout = torch.strided, device = device(type='cuda', index=1), pin_memory = False)
...
def load_args(reader):
    ...
    buf2 = reader.storage(None, 512, device=device(type='cuda', index=1), dtype_hint=torch.bfloat16)
    reader.tensor(buf2, (16, 16), dtype=torch.bfloat16, is_leaf=True)  # arg2_1
    buf3 = reader.storage(None, 512, device=device(type='cuda', index=1), dtype_hint=torch.bfloat16)
    ...
    buf7 = reader.storage(None, 512, device=device(type='cuda', index=1), dtype_hint=torch.bfloat16)
