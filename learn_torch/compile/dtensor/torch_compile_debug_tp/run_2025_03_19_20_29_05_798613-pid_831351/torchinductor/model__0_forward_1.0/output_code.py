...
# kernel path: /tmp/torchinductor_goon/3w/c3w55xbr47peimzbr4j63vmluwovvmzti65reqrozslejax2duuz.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_relu_0.run(buf2, 8, grid=grid(8), stream=stream0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_2 = rand_strided((8, 32), (32, 1), device='cuda:0', dtype=torch.float32)
