class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[1, 32]", primals_2: "f32[8, 32]", primals_3: "f32[32, 8]"):
        ...
        device_put: "f32[1, 32]" = torch.ops.prims.device_put.default(primals_1, device(type='cuda', index=2));  primals_1 = None
        ...
        all_reduce: "f32[1, 32]" = torch.ops._c10d_functional.all_reduce.default(mm_1, 'sum', '0');  mm_1 = None
