...
# kernel path: /tmp/torchinductor_goon/xa/cxakggn7ozkjfrqflgfviqdv7mkwhwoprjkqntzfsc22o7lxpnju.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(3):
        ...
        triton_poi_fused_relu_0.run(buf2, 8, grid=grid(8), stream=stream3)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_2 = rand_strided((8, 32), (32, 1), device='cuda:3', dtype=torch.float32)
    primals_3 = rand_strided((32, 8), (8, 1), device='cuda:3', dtype=torch.float32)
