class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[2, 4, 32, 64]", arg1_1: "f32[2, 2, 32, 64]", arg2_1: "f32[2, 2, 32, 64]"):
        ...
        view_8: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(clone_4, [2, 4, 32, 64]);  clone_4 = None
        
         # File: /gpfs/users/goon/github/garrett361/learn_torch/learn_torch/distributed/cp/torch_cp_inference.py:32 in torch_attn_primitives, code: v = v.unsqueeze(2).expand(-1, -1, gqa_ratio, -1, -1).flatten(1, 2)
        unsqueeze_7: "f32[2, 2, 1, 32, 64]" = torch.ops.aten.unsqueeze.default(wait_tensor_1, 2)
        ...
        view_9: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(clone_5, [2, 4, 32, 64]);  clone_5 = None
        ...
        view_10: "f32[8, 32, 64]" = torch.ops.aten.view.default(expand_8, [8, 32, 64]);  expand_8 = None
        expand_9: "f32[2, 4, 64, 32]" = torch.ops.aten.expand.default(permute_1, [2, 4, 64, 32]);  permute_1 = None
        view_11: "f32[8, 64, 32]" = torch.ops.aten.view.default(expand_9, [8, 64, 32]);  expand_9 = None
        bmm_2: "f32[8, 32, 32]" = torch.ops.aten.bmm.default(view_10, view_11);  view_10 = view_11 = None
        view_12: "f32[2, 4, 32, 32]" = torch.ops.aten.view.default(bmm_2, [2, 4, 32, 32]);  bmm_2 = None
        ...
        view_13: "f32[8, 32, 32]" = torch.ops.aten.view.default(expand_10, [8, 32, 32]);  expand_10 = None
        expand_11: "f32[2, 4, 32, 64]" = torch.ops.aten.expand.default(view_9, [2, 4, 32, 64]);  view_9 = None
        view_14: "f32[8, 32, 64]" = torch.ops.aten.view.default(expand_11, [8, 32, 64]);  expand_11 = None
        bmm_3: "f32[8, 32, 64]" = torch.ops.aten.bmm.default(view_13, view_14);  view_13 = view_14 = None
        view_15: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(bmm_3, [2, 4, 32, 64]);  bmm_3 = None
        ...
        sub_6: "f32[2, 4, 32, 1]" = torch.ops.aten.sub.Tensor(getitem, maximum);  getitem = None
        ...
        wait_tensor_2: "f32[2, 2, 32, 64]" = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_2);  all_to_all_single_2 = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:483 in all_to_all_single, code: tensor = torch.ops._c10d_functional.all_to_all_single(  # type: ignore[attr-defined]
        all_to_all_single_3: "f32[2, 2, 32, 64]" = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_1, [0, 0, 2, 0], [2, 0, 0, 0], '0');  wait_tensor_1 = None
        ...
        view_16: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(clone_6, [2, 4, 32, 64]);  clone_6 = None
        
         # File: /gpfs/users/goon/github/garrett361/learn_torch/learn_torch/distributed/cp/torch_cp_inference.py:32 in torch_attn_primitives, code: v = v.unsqueeze(2).expand(-1, -1, gqa_ratio, -1, -1).flatten(1, 2)
        unsqueeze_9: "f32[2, 2, 1, 32, 64]" = torch.ops.aten.unsqueeze.default(wait_tensor_3, 2)
        ...
        view_17: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(clone_7, [2, 4, 32, 64]);  clone_7 = None
        ...
        view_18: "f32[8, 32, 64]" = torch.ops.aten.view.default(expand_14, [8, 32, 64]);  expand_14 = None
        expand_15: "f32[2, 4, 64, 32]" = torch.ops.aten.expand.default(permute_2, [2, 4, 64, 32]);  permute_2 = None
        view_19: "f32[8, 64, 32]" = torch.ops.aten.view.default(expand_15, [8, 64, 32]);  expand_15 = None
        bmm_4: "f32[8, 32, 32]" = torch.ops.aten.bmm.default(view_18, view_19);  view_18 = view_19 = None
        view_20: "f32[2, 4, 32, 32]" = torch.ops.aten.view.default(bmm_4, [2, 4, 32, 32]);  bmm_4 = None
        ...
        view_21: "f32[8, 32, 32]" = torch.ops.aten.view.default(expand_16, [8, 32, 32]);  expand_16 = None
        expand_17: "f32[2, 4, 32, 64]" = torch.ops.aten.expand.default(view_17, [2, 4, 32, 64]);  view_17 = None
        view_22: "f32[8, 32, 64]" = torch.ops.aten.view.default(expand_17, [8, 32, 64]);  expand_17 = None
        bmm_5: "f32[8, 32, 64]" = torch.ops.aten.bmm.default(view_21, view_22);  view_21 = view_22 = None
        view_23: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(bmm_5, [2, 4, 32, 64]);  bmm_5 = None
        ...
        mul_6: "f32[2, 4, 32, 1]" = torch.ops.aten.mul.Tensor(exp_9, sum_3);  exp_9 = sum_3 = None
         ...
         # File: /gpfs/users/goon/github/garrett361/learn_torch/learn_torch/distributed/cp/torch_cp_inference.py:119 in torch_ring_attn_prefill, code: max_score - new_max_score
        sub_11: "f32[2, 4, 32, 1]" = torch.ops.aten.sub.Tensor(maximum, maximum_1);  maximum = None
        ...
        wait_tensor_4: "f32[2, 2, 32, 64]" = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_4);  all_to_all_single_4 = None
         ...
         # File: /gpfs/users/goon/.pyenv/versions/3.12.8/envs/torch-2.5.1/lib/python3.12/site-packages/torch/distributed/_functional_collectives.py:483 in all_to_all_single, code: tensor = torch.ops._c10d_functional.all_to_all_single(  # type: ignore[attr-defined]
        all_to_all_single_5: "f32[2, 2, 32, 64]" = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_3, [0, 0, 2, 0], [2, 0, 0, 0], '0');  wait_tensor_3 = None
        ...
        view_24: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(clone_8, [2, 4, 32, 64]);  clone_8 = None
        ...
        view_25: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(clone_9, [2, 4, 32, 64]);  clone_9 = None
        ...
        view_26: "f32[8, 32, 64]" = torch.ops.aten.view.default(expand_20, [8, 32, 64]);  expand_20 = None
        expand_21: "f32[2, 4, 64, 32]" = torch.ops.aten.expand.default(permute_3, [2, 4, 64, 32]);  permute_3 = None
        view_27: "f32[8, 64, 32]" = torch.ops.aten.view.default(expand_21, [8, 64, 32]);  expand_21 = None
        bmm_6: "f32[8, 32, 32]" = torch.ops.aten.bmm.default(view_26, view_27);  view_26 = view_27 = None
        view_28: "f32[2, 4, 32, 32]" = torch.ops.aten.view.default(bmm_6, [2, 4, 32, 32]);  bmm_6 = None
        ...
        view_29: "f32[8, 32, 32]" = torch.ops.aten.view.default(expand_22, [8, 32, 32]);  expand_22 = None
        expand_23: "f32[2, 4, 32, 64]" = torch.ops.aten.expand.default(view_25, [2, 4, 32, 64]);  view_25 = None
        view_30: "f32[8, 32, 64]" = torch.ops.aten.view.default(expand_23, [8, 32, 64]);  expand_23 = None
        bmm_7: "f32[8, 32, 64]" = torch.ops.aten.bmm.default(view_29, view_30);  view_29 = view_30 = None
        view_31: "f32[2, 4, 32, 64]" = torch.ops.aten.view.default(bmm_7, [2, 4, 32, 64]);  bmm_7 = None
        ...
        mul_10: "f32[2, 4, 32, 1]" = torch.ops.aten.mul.Tensor(exp_14, sum_4);  exp_14 = sum_4 = None
         ...
         # File: /gpfs/users/goon/github/garrett361/learn_torch/learn_torch/distributed/cp/torch_cp_inference.py:119 in torch_ring_attn_prefill, code: max_score - new_max_score
        sub_16: "f32[2, 4, 32, 1]" = torch.ops.aten.sub.Tensor(maximum_1, maximum_2);  maximum_1 = maximum_2 = None
