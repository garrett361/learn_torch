...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1):
        ...
        all_to_all_single = torch.ops._c10d_functional.all_to_all_single.default(clone_2, [0, 0, 2, 0], [2, 0, 0, 0], '0');  clone_2 = None
        ...
        all_to_all_single_1 = torch.ops._c10d_functional.all_to_all_single.default(clone_3, [0, 0, 2, 0], [2, 0, 0, 0], '0');  clone_3 = None
        ...
        all_to_all_single_2 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor, [0, 0, 2, 0], [2, 0, 0, 0], '0');  wait_tensor = None
        wait_tensor_2 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_2);  all_to_all_single_2 = None
        all_to_all_single_3 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_1, [0, 0, 2, 0], [2, 0, 0, 0], '0');  wait_tensor_1 = None
        ...
        expand_14 = torch.ops.aten.expand.default(arg0_1, [2, 4, 32, 64])
        ...
        sub_11 = torch.ops.aten.sub.Tensor(maximum, maximum_1);  maximum = None
        ...
        all_to_all_single_4 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_2, [0, 0, 2, 0], [2, 0, 0, 0], '0');  wait_tensor_2 = None
        wait_tensor_4 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_4);  all_to_all_single_4 = None
        all_to_all_single_5 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_3, [0, 0, 2, 0], [2, 0, 0, 0], '0');  wait_tensor_3 = None
        wait_tensor_5 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_5);  all_to_all_single_5 = None
        unsqueeze_10 = torch.ops.aten.unsqueeze.default(wait_tensor_4, 2);  wait_tensor_4 = None
        expand_18 = torch.ops.aten.expand.default(unsqueeze_10, [-1, -1, 2, -1, -1]);  unsqueeze_10 = None
        clone_8 = torch.ops.aten.clone.default(expand_18, memory_format = torch.contiguous_format);  expand_18 = None
        view_24 = torch.ops.aten.view.default(clone_8, [2, 4, 32, 64]);  clone_8 = None
        unsqueeze_11 = torch.ops.aten.unsqueeze.default(wait_tensor_5, 2);  wait_tensor_5 = None
        expand_19 = torch.ops.aten.expand.default(unsqueeze_11, [-1, -1, 2, -1, -1]);  unsqueeze_11 = None
        clone_9 = torch.ops.aten.clone.default(expand_19, memory_format = torch.contiguous_format);  expand_19 = None
        view_25 = torch.ops.aten.view.default(clone_9, [2, 4, 32, 64]);  clone_9 = None
        permute_3 = torch.ops.aten.permute.default(view_24, [0, 1, 3, 2]);  view_24 = None
        expand_20 = torch.ops.aten.expand.default(arg0_1, [2, 4, 32, 64]);  arg0_1 = None
        view_26 = torch.ops.aten.view.default(expand_20, [8, 32, 64]);  expand_20 = None
        expand_21 = torch.ops.aten.expand.default(permute_3, [2, 4, 64, 32]);  permute_3 = None
        view_27 = torch.ops.aten.view.default(expand_21, [8, 64, 32]);  expand_21 = None
        bmm_6 = torch.ops.aten.bmm.default(view_26, view_27);  view_26 = view_27 = None
        view_28 = torch.ops.aten.view.default(bmm_6, [2, 4, 32, 32]);  bmm_6 = None
        div_3 = torch.ops.aten.div.Tensor(view_28, 8.0);  view_28 = None
        max_4 = torch.ops.aten.max.dim(div_3, -1, True)
        getitem_6 = max_4[0];  max_4 = None
        sub_12 = torch.ops.aten.sub.Tensor(div_3, getitem_6);  div_3 = None
        exp_11 = torch.ops.aten.exp.default(sub_12);  sub_12 = None
        expand_22 = torch.ops.aten.expand.default(exp_11, [2, 4, 32, 32])
        view_29 = torch.ops.aten.view.default(expand_22, [8, 32, 32]);  expand_22 = None
        expand_23 = torch.ops.aten.expand.default(view_25, [2, 4, 32, 64]);  view_25 = None
        view_30 = torch.ops.aten.view.default(expand_23, [8, 32, 64]);  expand_23 = None
        bmm_7 = torch.ops.aten.bmm.default(view_29, view_30);  view_29 = view_30 = None
        view_31 = torch.ops.aten.view.default(bmm_7, [2, 4, 32, 64]);  bmm_7 = None
        sum_4 = torch.ops.aten.sum.dim_IntList(exp_11, [-1], True);  exp_11 = None
        maximum_2 = torch.ops.aten.maximum.default(maximum_1, getitem_6)
        sub_13 = torch.ops.aten.sub.Tensor(getitem_6, maximum_2)
        exp_12 = torch.ops.aten.exp.default(sub_13);  sub_13 = None
        mul_8 = torch.ops.aten.mul.Tensor(exp_12, view_31);  exp_12 = view_31 = None
        sub_14 = torch.ops.aten.sub.Tensor(maximum_1, maximum_2)
        exp_13 = torch.ops.aten.exp.default(sub_14);  sub_14 = None
        mul_9 = torch.ops.aten.mul.Tensor(exp_13, add_2);  exp_13 = add_2 = None
        add_4 = torch.ops.aten.add.Tensor(mul_8, mul_9);  mul_8 = mul_9 = None
        sub_15 = torch.ops.aten.sub.Tensor(getitem_6, maximum_2);  getitem_6 = None
        exp_14 = torch.ops.aten.exp.default(sub_15);  sub_15 = None
        mul_10 = torch.ops.aten.mul.Tensor(exp_14, sum_4);  exp_14 = sum_4 = None
        sub_16 = torch.ops.aten.sub.Tensor(maximum_1, maximum_2);  maximum_1 = maximum_2 = None
        exp_15 = torch.ops.aten.exp.default(sub_16);  sub_16 = None
        mul_11 = torch.ops.aten.mul.Tensor(exp_15, add_3);  exp_15 = add_3 = None
        add_5 = torch.ops.aten.add.Tensor(mul_10, mul_11);  mul_10 = mul_11 = None
        div_4 = torch.ops.aten.div.Tensor(add_4, add_5);  add_4 = add_5 = None
        return (div_4,)
        
def load_args(reader):
    buf0 = reader.storage(None, 262144)
    reader.tensor(buf0, (2, 4, 32, 64), (32768, 8192, 64, 1), storage_offset=6144, is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 262144)
    reader.tensor(buf1, (2, 2, 32, 64), (32768, 16384, 128, 1), storage_offset=12288, is_leaf=True)  # arg1_1
    reader.tensor(buf1, (2, 2, 32, 64), (32768, 16384, 128, 1), storage_offset=12352, is_leaf=True)  # arg2_1
