...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1):
        ...
        all_to_all_single = torch.ops._c10d_functional.all_to_all_single.default(clone_2, [2, 0, 0, 0], [0, 0, 2, 0], '0');  clone_2 = None
        ...
        all_to_all_single_1 = torch.ops._c10d_functional.all_to_all_single.default(clone_3, [2, 0, 0, 0], [0, 0, 2, 0], '0');  clone_3 = None
        ...
        expand_8 = torch.ops.aten.expand.default(arg0_1, [2, 4, 32, 64]);  arg0_1 = None
        ...
        sub_6 = torch.ops.aten.sub.Tensor(getitem, maximum);  getitem = maximum = None
        ...
        all_to_all_single_2 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor, [2, 0, 0, 0], [0, 0, 2, 0], '0');  wait_tensor = None
        wait_tensor_2 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_2);  all_to_all_single_2 = None
        all_to_all_single_3 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_1, [2, 0, 0, 0], [0, 0, 2, 0], '0');  wait_tensor_1 = None
        wait_tensor_3 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_3);  all_to_all_single_3 = None
        all_to_all_single_4 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_2, [2, 0, 0, 0], [0, 0, 2, 0], '0');  wait_tensor_2 = None
        wait_tensor_4 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_4);  all_to_all_single_4 = wait_tensor_4 = None
        all_to_all_single_5 = torch.ops._c10d_functional.all_to_all_single.default(wait_tensor_3, [2, 0, 0, 0], [0, 0, 2, 0], '0');  wait_tensor_3 = None
        wait_tensor_5 = torch.ops._c10d_functional.wait_tensor.default(all_to_all_single_5);  all_to_all_single_5 = wait_tensor_5 = None
        div_2 = torch.ops.aten.div.Tensor(add, add_1);  add = add_1 = None
        return (div_2,)
        
def load_args(reader):
    buf0 = reader.storage(None, 262144)
    reader.tensor(buf0, (2, 4, 32, 64), (32768, 8192, 64, 1), storage_offset=2048, is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 262144)
    reader.tensor(buf1, (2, 2, 32, 64), (32768, 16384, 128, 1), storage_offset=4096, is_leaf=True)  # arg1_1
    reader.tensor(buf1, (2, 2, 32, 64), (32768, 16384, 128, 1), storage_offset=4160, is_leaf=True)  # arg2_1
